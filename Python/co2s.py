...
address = dat[(dat['variable_id'] == 'co2s')].zstore.iloc[0]
address_ten = dat[(dat['variable_id'] == 'co2s')].zstore.iloc[0:11]
address_all = dat[(dat['variable_id'] == 'co2s')].zstore
